...
use PmAnalyticsPackage\api\Google\API\SummaryOrganicTrafficAPI;

class SummaryOrganicTrafficReport extends AnalyticsController
{
    public function getAnalyticsData($dealerCode, $startDate, $endDate)
    {
        ...
        $ga = new SummaryOrganicTrafficAPI(
            $dealer,
            $startDate,
            $endDate,
