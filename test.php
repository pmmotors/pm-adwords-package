...
use PmAnalyticsPackage\api\Google\Controllers\SummaryOrganicTrafficReport;
use PmAnalyticsPackage\api\Google\Controllers\SummaryVisitsUsersReport;
...
// $analytics = new SummaryVisitsUsersReport();
$analytics = new SummaryOrganicTrafficReport();
